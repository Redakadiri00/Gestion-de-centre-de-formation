...
<body>
    ...
    <main>
        ...
        $sql = "SELECT matricule33,prenom33,nom33,tele_etudiant33,email33,tele_parent33,nbr_seances_rest33 FROM etudiant_reserve";
    ...
    echo "<tr>
            <td>" . $row["matricule33"] . "</td>
            <td>" . $row["prenom33"] . "</td>
            <td>" . $row["nom33"] . "</td>
            <td>" . $row["tele_etudiant33"] . "</td>
            <td>" . $row["email33"] . "</td>
            <td>" . $row["tele_parent33"] . "</td>
            <td>" . $row["nbr_seances_rest33"] . "</td>
          </tr>";
}
