...
<body>
    ...
    <main>
        <div class="search-container">
            ...
            <form action="testsearchid.php" method="post">
                <label for="searchByCode">Chercher par l'ID :</label><br><br>
                <input type="int" id="searchByCode" name="Code" required>
        ...
        <div class="button-container">
            ...
            <a href="search.php">
                <button style="background-color: #FF4081; color: #fff; padding: 8px 16px; border: none; font-size: 14px; cursor: pointer;">
                    Chercher par le nom ?
                </button>
            </a>
        </div>
