...
try {
    ...
    $sql = "SELECT etudiant.prenom, etudiant.nom, etudiant.tele_etudiant, etudiant.email, etudiant.tele_parent
        FROM etudiant
        WHERE etudiant.prenom LIKE :code OR etudiant.prenom LIKE :code";
...
<header>
    ...
    if (!empty($resultat)) {
        echo "<table>";
        echo "<tr><th>Prenom</th><th>Nom</th><th>Tele etudiant</th><th>Email</th><th>Tele parent</th></tr>";
